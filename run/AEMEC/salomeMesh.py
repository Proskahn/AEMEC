...
anodeInlet = geompy.CreateGroup(Geo, geompy.ShapeType["FACE"])
geompy.UnionIDs(anodeInlet, [585])
cathodeInlet = geompy.CreateGroup(Geo, geompy.ShapeType["FACE"])
geompy.UnionIDs(cathodeInlet, [121])
anodeOutlet = geompy.CreateGroup(Geo, geompy.ShapeType["FACE"])
geompy.UnionIDs(anodeOutlet, [587])
cathodeOutlet = geompy.CreateGroup(Geo, geompy.ShapeType["FACE"])
geompy.UnionIDs(cathodeOutlet, [123])
anodeSides = geompy.CreateGroup(Geo, geompy.ShapeType["FACE"])
geompy.UnionIDs(anodeSides, [540, 434, 482, 424, 492, 376, 428, 529, 544, 546, 396, 394, 488, 452, 527, 469, 430, 413, 454, 510, 411, 471, 486, 512])
cathodeSides = geompy.CreateGroup(Geo, geompy.ShapeType["FACE"])
geompy.UnionIDs(cathodeSides, [222, 181, 295, 239, 164, 196, 312, 314, 198, 220, 297, 254, 256, 162, 179, 237, 278, 280, 308, 202, 192, 250, 144, 260])
...
anodeChannel = geompy.CreateGroup(Geo, geompy.ShapeType["SOLID"])
geompy.UnionIDs(anodeChannel, [572])
cathodeChannel = geompy.CreateGroup(Geo, geompy.ShapeType["SOLID"])
geompy.UnionIDs(cathodeChannel, [108])
cathodeGDL = geompy.CreateGroup(Geo, geompy.ShapeType["SOLID"])
geompy.UnionIDs(cathodeGDL, [142, 166, 183])
anodeGDL = geompy.CreateGroup(Geo, geompy.ShapeType["SOLID"])
geompy.UnionIDs(anodeGDL, [514, 490, 531])
anodeMPL = geompy.CreateGroup(Geo, geompy.ShapeType["SOLID"])
geompy.UnionIDs(anodeMPL, [432, 456, 473])
anodeCL = geompy.CreateGroup(Geo, geompy.ShapeType["SOLID"])
geompy.UnionIDs(anodeCL, [374, 415, 398])
electrolyte = geompy.CreateGroup(Geo, geompy.ShapeType["SOLID"])
geompy.UnionIDs(electrolyte, [340, 316, 357])
cathodeCL = geompy.CreateGroup(Geo, geompy.ShapeType["SOLID"])
geompy.UnionIDs(cathodeCL, [282, 258, 299])
cathodeMPL = geompy.CreateGroup(Geo, geompy.ShapeType["SOLID"])
geompy.UnionIDs(cathodeMPL, [224, 241, 200])
...
geompy.addToStudyInFather( Geo, anodeInlet, 'anodeInlet' )
geompy.addToStudyInFather( Geo, cathodeInlet, 'cathodeInlet' )
geompy.addToStudyInFather( Geo, anodeOutlet, 'anodeOutlet' )
geompy.addToStudyInFather( Geo, cathodeOutlet, 'cathodeOutlet' )
...
geompy.addToStudyInFather( Geo, anodeChannel, 'anodeChannel' )
geompy.addToStudyInFather( Geo, cathodeChannel, 'cathodeChannel' )
geompy.addToStudyInFather( Geo, cathodeGDL, 'cathodeGDL' )
geompy.addToStudyInFather( Geo, anodeGDL, 'anodeGDL' )
geompy.addToStudyInFather( Geo, anodeMPL, 'anodeMPL' )
geompy.addToStudyInFather( Geo, anodeCL, 'anodeCL' )
geompy.addToStudyInFather( Geo, electrolyte, 'electrolyte' )
geompy.addToStudyInFather( Geo, cathodeCL, 'cathodeCL' )
geompy.addToStudyInFather( Geo, cathodeMPL, 'cathodeMPL' )
...
anodeInlet = geo.GroupOnGeom(anodeInlet,'anodeInlet',SMESH.FACE)
cathodeInlet = geo.GroupOnGeom(cathodeInlet,'cathodeInlet',SMESH.FACE)
anodeOutlet = geo.GroupOnGeom(anodeOutlet,'anodeOutlet',SMESH.FACE)
cathodeOutlet = geo.GroupOnGeom(cathodeOutlet,'cathodeOutlet',SMESH.FACE)
...
anodeChannel = geo.GroupOnGeom(anodeChannel,'anodeChannel',SMESH.VOLUME)
cathodeChannel = geo.GroupOnGeom(cathodeChannel,'cathodeChannel',SMESH.VOLUME)
cathodeGDL = geo.GroupOnGeom(cathodeGDL,'cathodeGDL',SMESH.VOLUME)
anodeGDL = geo.GroupOnGeom(anodeGDL,'anodeGDL',SMESH.VOLUME)
anodeMPL = geo.GroupOnGeom(anodeMPL,'anodeMPL',SMESH.VOLUME)
anodeCL = geo.GroupOnGeom(anodeCL,'anodeCL',SMESH.VOLUME)
electrolyte = geo.GroupOnGeom(electrolyte,'electrolyte',SMESH.VOLUME)
cathodeCL = geo.GroupOnGeom(cathodeCL,'cathodeCL',SMESH.VOLUME)
cathodeMPL = geo.GroupOnGeom(cathodeMPL,'cathodeMPL',SMESH.VOLUME)
