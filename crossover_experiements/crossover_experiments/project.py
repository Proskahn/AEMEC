...
DEFAULT_CURRENT_SWEEP_NAME = "current-sweep-0-to-2Acm2"
DEFAULT_CURRENT_SWEEP_OUTPUT_DIR = (
    PACKAGE_ROOT / "results" / DEFAULT_CURRENT_SWEEP_NAME
)
DEFAULT_CURRENT_SWEEP_WORK_DIR = (
    PACKAGE_ROOT / "work" / DEFAULT_CURRENT_SWEEP_NAME
)


__all__ = [
    "DEFAULT_OUTPUT_DIR",
    "DEFAULT_CURRENT_SWEEP_NAME",
    "DEFAULT_CURRENT_SWEEP_OUTPUT_DIR",
    "DEFAULT_CURRENT_SWEEP_WORK_DIR",
    "DEFAULT_SOURCE_CASE",
    "DEFAULT_STUDY_NAME",
