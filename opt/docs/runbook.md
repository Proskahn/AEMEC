...
Overlay the stored polarization and H2-crossover curves for the 20, 40, 60,
...
The two-panel comparison is written as
`selected_polarization_and_crossover_curves.png` in the study directory. Use
`--thicknesses` to select a different set.
